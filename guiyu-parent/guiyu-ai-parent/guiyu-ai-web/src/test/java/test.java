...
public class test {
    ...
    final String accessKeyId = "LTAInHHRM9fM0PHK";
    final String accessKeySecret = "tBBA0vyrBc7zfLSsQpBNTSMh3qa6tA";
    final String appKey = "7mvC7CqfaKDWwfpN";
    @Test
    public void test() throws Exception{
        ...
        if (statusText.equals("SUCCESS") || statusText.equals("SUCCESS_WITH_NO_VALID_FRAGMENT")) {
            ...
            System.out.println("耗时/ms：" + consumeTime);
