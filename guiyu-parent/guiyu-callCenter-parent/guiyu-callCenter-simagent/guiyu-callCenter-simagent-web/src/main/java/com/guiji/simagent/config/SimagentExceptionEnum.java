 ...
 * simagent服务异常的枚举
 */
public enum SimagentExceptionEnum implements ExceptionEnum {
...
//    EXCP_FSAGENT_FSMANAGER_LINEXMLINFOS("0300007","从fsmanager服务获取线路信息失败"),
    ...
    //根据枚举的code获取msg的方法
    public static SimagentExceptionEnum getMsgByErrorCode(String errorCode){
        for(SimagentExceptionEnum simagentExceptionEnum : SimagentExceptionEnum.values()) {
            if(simagentExceptionEnum.getErrorCode().equals(errorCode)){
                return simagentExceptionEnum;
            }
        }
        return null;
    }

    SimagentExceptionEnum(String errorCode, String msg) {
        this.errorCode = errorCode;
        this.msg = msg;
    }
