...
public interface ExportFileRecordMapper {
    ...
    //查询记录列表(分页)
    List<ExportFileRecord> queryExportFileRecordByPage(@Param("queryRecord") ExportFileRecord queryRecord,
                                                       @Param("page") ResultPage<ExportFileRecord> page);

    //查询记录数量
    int queryExportFileRecordCount(@Param("queryRecord") ExportFileRecord queryRecord);
