...
@Component
@RabbitListener(queues = "fanout.dispatch.BatchImportSaveDB.SAVEDB", containerFactory = "batchImportSaveDBRabbitFactory")
public class BatchImportSaveDBMQListener
{
