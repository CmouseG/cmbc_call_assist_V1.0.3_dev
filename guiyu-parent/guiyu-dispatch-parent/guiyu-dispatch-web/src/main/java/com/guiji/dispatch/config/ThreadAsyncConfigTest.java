...
//@Configuration
//@EnableAsync
//public class ThreadAsyncConfigTest {
//		
//	@Bean(name = "asyncDispatchPlanCleanExecutor")
//	public Executor asyncDispatchPlanCleanExecutor() {
...
//	    //等待队列
//	    threadPool.setQueueCapacity(9999);
//	    //等待任务在关机时完成--表明等待所有线程执行完
//	    threadPool.setWaitForTasksToCompleteOnShutdown(true);
//	    // 等待时间 （默认为0，此时立即停止），并没等待xx秒后强制停止
//	    threadPool.setAwaitTerminationSeconds(60);
//	    //  线程名称前缀
//	    threadPool.setThreadNamePrefix("async-process-");
