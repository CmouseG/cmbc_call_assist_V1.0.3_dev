...
public enum CmdTypeEnum {
    ...
    UNKNOWN(-1), START(0), STOP(1), HEALTH(2), RESTART(3), REGISTER(4), RESTORE_MODEL(5), UNREGISTER(6),AGENTREGISTER(7),PULBLISH_SELLBOT_BOTSTENCE(8),PULBLISH_FREESWITCH_BOTSTENCE(9);
