...
public class RobotConstants {
	...
	public static final String TTS_INTERFACE_UNDO = "undo"; //未处理
	public static final String TTS_INTERFACE_DOING = "doing"; //处理中
	public static final String TTS_INTERFACE_DONE = "done"; //处理完成
	public static final String TTS_INTERFACE_FAIL = "fail"; //处理失败
