...
public class QiYeBao implements ISendMessage
{
	private static final Logger log = LoggerFactory.getLogger(QiYeBao.class);
	...
	private SmsSendDetail send(JSONObject params, String phone)
	{
		...
		paramsList.add(new BasicNameValuePair("passwd", params.getString("passwd")));
	...
	private String doPost(List<NameValuePair> paramsList)
	{
		...
		try
		{
			...
			result = "{\"respcode\":\"404\",\"respdesc\":\"调用短信平台商服务异常\"}";
		}
		finally {
