...
Source Database       : guiyu_billing

Target Server Type    : MYSQL
Target Server Version : 50722
File Encoding         : 65001

Date: 2019-03-12 17:09:13
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for billing_acct_charging_record
-- ----------------------------
...
CREATE TABLE `billing_acct_charging_record` (
  ...
  `oper_user_org_code` varchar(30) NOT NULL COMMENT '用户编码',
  ...
  `charging_amount` decimal(16,2) DEFAULT NULL COMMENT '计费金额',
  PRIMARY KEY (`id`),
  KEY `idx_acct_charging_record` (`account_id`)
) ENGINE=InnoDB AUTO_INCREMENT=104431 DEFAULT CHARSET=utf8 COMMENT='用户计费流水记录表';

-- ----------------------------
-- Table structure for billing_acct_charging_term
-- ----------------------------
...
) ENGINE=InnoDB AUTO_INCREMENT=80 DEFAULT CHARSET=utf8 COMMENT='账户计费项表';

-- ----------------------------
-- Table structure for billing_acct_charging_total
-- ----------------------------
...
-- ----------------------------
-- Table structure for billing_acct_reconciliation
-- ----------------------------
...
-- ----------------------------
-- Table structure for billing_acct_set
-- ----------------------------
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='用户账户设置表';

-- ----------------------------
-- Table structure for billing_charging_term
-- ----------------------------
...
-- ----------------------------
-- Table structure for billing_exception_retry_record
-- ----------------------------
...
-- ----------------------------
-- Table structure for billing_notify_busi_record
-- ----------------------------
...
-- ----------------------------
-- Table structure for billing_notify_msg_record
-- ----------------------------
...
-- ----------------------------
-- Table structure for billing_total_charging
-- ----------------------------
...
) ENGINE=InnoDB AUTO_INCREMENT=205 DEFAULT CHARSET=utf8 COMMENT='费用统计表';

-- ----------------------------
-- Table structure for billing_user_acct
-- ----------------------------
...
CREATE TABLE `billing_user_acct` (
  ...
  `org_code` varchar(30) NOT NULL COMMENT '公司编码',
...
) ENGINE=InnoDB AUTO_INCREMENT=79 DEFAULT CHARSET=utf8 COMMENT='计费用户账户表';

-- ----------------------------
-- Procedure structure for totalChargingByDate
-- ----------------------------
...
BEGIN
		...
		DECLARE total_mode INT;				
		DECLARE total_date VARCHAR(16);			
		DECLARE recharge_amount DECIMAL(16,2);		
		DECLARE consume_amount DECIMAL(16,2);		
...
-- ----------------------------
-- Procedure structure for totalChargingByMonth
-- ----------------------------
