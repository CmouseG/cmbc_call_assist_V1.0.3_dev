...
ALTER TABLE  `black_list` ADD COLUMN create_user_name varchar(8) DEFAULT 0 COMMENT '创建用户名';
ALTER TABLE  `black_list` ADD COLUMN update_user_name varchar(8) DEFAULT 0 COMMENT '修改用户名字';
