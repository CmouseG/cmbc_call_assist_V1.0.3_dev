...
def move(name, cfgs_name, postfix, dir_name):
    if not os.path.isdir('/home/botstence_tmpl/' + cfgs_name + '_en'):
        os.makedirs('/home/botstence_tmpl/' + cfgs_name + '_en')

    cmd_cp = "cp -r {}/{}{} /home/botstence_tmpl/{}/{}{}" \
        .format(dir_name, cfgs_name, postfix, cfgs_name + '_en', cfgs_name, postfix)
    if exists("/home/botstence_tmpl/{}/{}{}".format(cfgs_name + '_en', cfgs_name, postfix)):
        cmd_bak = "mv /home/botstence_tmpl/{}/{}{} /home/botstence_tmpl/{}/{}{}_{}" \
...
def main(c_url, c_dir):
    ...
    if not os.path.isdir(c_dir):
        os.makedirs(c_dir)
    if not os.path.isdir('/home/botstence_tmpl/'):
        os.makedirs('/home/botstence_tmpl/')
